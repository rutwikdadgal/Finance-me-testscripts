package com.testing.banking_selenium_testing;
...
public class App 
{
    public static void main( String[] args ) throws InterruptedException, IOException
    {
        ...
        driver.findElement(By.name("Name")).sendKeys("Rutwik");
        Thread.sleep(3000);
        driver.findElement(By.name("Phone Number")).sendKeys("9999999999");
        Thread.sleep(3000);
        driver.findElement(By.name("Email")).sendKeys("rutwik@xyz");
        Thread.sleep(3000);
        driver.findElement(By.name("Message")).sendKeys("Hello! i have submitted the above info.");
        Thread.sleep(3000);
